    ...
    <div class="main-sliding-container active" id="mainContainer">
        ...
        <div class="form-side family-side">
            <div class="max-w-xl w-full mx-auto text-center">
                <div class="mb-14">
                    <p class="text-custom-red italic text-lg md:text-xl font-bold tracking-[0.4em] uppercase mb-4">Intranet</p>
                    <h1 class="text-6xl md:text-9xl font-black text-custom-red tracking-tighter uppercase leading-none">Academia</h1>
                </div>
                ...
                <form class="space-y-8 text-left" method="POST" action="#">
                    ...
                    <button type="submit" class="w-full btn-custom-effect text-white font-black py-8 rounded-[2rem] shadow-custom-red text-3xl uppercase tracking-widest mt-6">
                        <span>Ingresar</span>
                    </button>
                </form>

                <div class="mt-8">
                    <a href="#" class="text-xl font-bold text-slate-400 hover:text-custom-red transition-colors">¿Olvidaste tu contraseña?</a>
                </div>
                ...
                <div class="mt-6 flex flex-col items-center">
                    <div class="text-slate-400 text-[11px] font-bold uppercase tracking-widest flex items-center gap-3 whitespace-nowrap footer-links">
                        <a href="#" class="hover:text-custom-red underline decoration-1 underline-offset-4 transition-colors">Términos y condiciones</a>
                        <span class="text-slate-300">/</span>
                        <a href="#" class="hover:text-custom-red underline decoration-1 underline-offset-4 transition-colors">Política de protección de datos personales</a>
                    </div>
        ...
        <div class="form-side student-side">
            <div class="absolute top-8 left-8 md:top-12 md:left-12 container-back-btn">
                <a href="{{ route('portal') }}" class="inline-block btn-custom-effect rounded-2xl p-4 shadow-custom-red">
            ...
            <div class="max-w-xl w-full mx-auto text-center academy-content-wrapper">
                <div class="mb-14">
                    <p class="text-custom-red italic text-lg md:text-xl font-bold tracking-[0.4em] uppercase mb-4">Intranet</p>
                    <h1 class="text-6xl md:text-9xl font-black text-custom-red tracking-tighter uppercase leading-none">Academia</h1>
                </div>
                ...
                <form class="space-y-8 text-left" method="POST" action="#">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <button id="togglePassword" type="button" class="absolute right-8 text-slate-400 hover:text-custom-red">
                ...
                <div class="mt-6 flex flex-col items-center">
                    <div class="text-slate-400 text-[11px] font-bold uppercase tracking-widest flex items-center gap-3 footer-links">
                        <a href="#" class="hover:text-custom-red underline transition-colors">Términos y condiciones</a>
                        <span class="text-slate-300">/</span>
                        <a href="#" class="hover:text-custom-red underline transition-colors">Política de protección de datos personales</a>
                    </div>
                    <p class="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] mt-4">
                        © 2026 Next Level. Todos los derechos reservados.
                    </p>
