    ...
    <div class="main-sliding-container active" id="mainContainer">
        ...
        <div class="form-side family-side">
            <div class="max-w-xl w-full mx-auto text-center">
                <div class="mb-14">
                    <p class="text-custom-red italic text-xl font-bold tracking-[0.4em] uppercase mb-4">Intranet</p>
                    <h1 class="text-9xl font-black text-custom-red tracking-tighter uppercase leading-none">Academia</h1>
                </div>
                ...
                <div class="mt-8"> <a href="#" class="text-xl font-bold text-slate-400 hover:text-custom-red transition-colors">¿Olvidaste tu contraseña?</a>
                </div>

                <div class="social-icons-wrapper !mt-8"> <a href="https://www.tiktok.com/@next_level_novus?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" class="social-btn"><i class="fab fa-tiktok"></i></a>
